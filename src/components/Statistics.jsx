  ...
  return (
    <>
        <div className='flex items-center justify-center '>
            <div className='flex flex-col items-center justify-center'>
                ...
                <h1 className='text-5xl font-bold text-primary tracking-wide flex items-center ml-4 justify-center text-white'>Some of Our Achievements</h1>
                <div>
    ...
    <div className='max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 items-center justify-center pt-20 mb-10'>
        <div className='border border-gray-800 shadow flex flex-col items-center min-h-[280px] py-5 px-12 hover:bg-gray-400 rounded-lg'>
            ...
            src={statistics1}
            alt='statistics1'
            className='bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% w- px-5 py-5 rounded-full mb-5 rounded-md'/>
            <h2 className='text-3xl font-bold tracking-wide mb-3'>2,390</h2>
        ...
        <div className='border border-gray-800 shadowflex flex-col items-center min-h-[280px] py-5 px-12 hover:bg-gray-400 rounded-lg'>
            <img
            src={statistics3}
            alt='statistics1'
            className='bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% w- px-5 py-4 rounded-md mb-5'/>
            <h2 className='text-3xl font-bold tracking-wide  mb-3'>
                100%</h2>
