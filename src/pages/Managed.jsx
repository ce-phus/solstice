...
import { managed1, managed5, managed6, managed7, circle, star, send, shield } from '../assets'
    ...
    <>
      ...
      <div className='absolute z-[1] w-[80%] h-[30%]  blue__gradient'/>
        ...
        <div className='flex flex-col'>
                ...
                <p className='mt-3 tracking-wide text-lg text-secondary'>
      ...
      <div className='pt-20 flex flex-col items-center justify-center max-w-7xl mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-7'>
          <div className='mt-10 mx-4 lg:mx-0 flex flex-col'>
            ...
            <p className='mt-4 text-secondary tracking-wide text-lg'>IT is a field that encompasses everything related to your hardware, software, network, and security. With an expert team dedicated to providing managed IT services for your business, we cover everything you need to stay secure, connected, and efficient.</p>
            <p className='mt-4 text-secondary tracking-wide text-lg'>Our managed IT services addresses all of these and more to provide you with solutions that fit your exact needs while staying budget friendly.</p>
          </div>
          <div className='border border-gray-700 mt-10 flex flex-col pl-10'>
            ...
            <div className='flex mt-4'>
              ...
              <p>Network Downtime</p>
            </div>
            <div className='flex mt-4'>
              <TiTickOutline className='mt-1 mr-2'/>
              <p>Slow/Malfunctioning IT</p>
            </div>
            <div className='flex mt-4'>
              <TiTickOutline className='mt-1 mr-2'/>
              <p>Costly Tech Support</p>
            </div>
            <div className='flex mt-4'>
              <TiTickOutline className='mt-1 mr-2'/>
              <p>Unresponsive/Limited IT Support</p>
            </div>
            <div className='flex mt-4 mb-10'>
              <TiTickOutline className='mt-1 mr-2'/>
              <p>One-size-fits-all Tech</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className='flex items-center justify-center max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-5'>
          ...
          <div className='mx-3 pl-10'>
            ...
            <h1 className='text-4xl font-bold tracking-wide mt-6 mb-3 '>Don't Be Left Out !</h1>
              ...
              <p className='tracking-wide text-lg text-secondary mt-5 mx-3 md:mx-0 md:w-3/4 mb-3'>From simply saving time to improving resource management, our managed IT services benefits can be seen instantly after implementation.</p>
            ...
            <div className='flex mt-5'>
                ...
                <div className='flex flex-col '>
                  ...
                  <p className='ml-3 text-lg text-secondary mt-2'> Every piece of hardware, software, and IT for your business requires different personnel with expertise on that subject. With our managed IT services, you get access to experts in various IT fields to help manage any IT project.</p>
                </div>
            </div>
            </div>
          </div>
      ...
      <div className='bg-tertiary/40 py-20 flex flex-col justify-center items-center  lg:mx-0'>
          ...
          <p className='mt-5 text-lg text-secondary lg:w-1/2 mx-5'>Optimize your business with managed IT services that provide increased productivity, safety, and profitability. Contact us today for a free consultation and find
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-5 flex max-w-7xl mx-auto pt-20'>
              <div className='flex items-center flex-col'>
                <h1 className='text-2xl font-bold mb-3'>What is a managed IT service?</h1>
                  <p className='text-lg text-secondary mx-3 mb-3'>A managed service is one that is outsource to a third-party. In the case of a managed IT service, all of your IT needs and activity are outsourced. For smaller businesses, this usually results in a more budget-friendly IT department.</p>
                  <p className='text-lg text-secondary mx-3'>Every business needs and IT department. If you have a website, communicate through email, and store data of any kind, then that falls under IT. Without managing your IT, you put your business at risk. Our managed IT services keeps your business protected and managed.</p>
              </div>
              <div className='flex items-center flex-col'>
                <h1 className='text-2xl font-bold mb-3'>What is the difference between a Managed Service Provider and Managed IT Services?</h1>
                  <p className='text-lg text-secondary mx-3 mb-3'>Managed IT services are fulfilled by an MSP, a Managed Service Provider. In the case of Solstice IT Services, we act as your MSP when you subscribe to our managed IT services.</p>
                  <p className='text-lg text-secondary mx-3'>Using an MSP is a better solution for small businesses who cannot afford or do not need their own in-house IT team. It is economical while keeping your valuable business efficiently running.</p>
              </div>
              <div className='flex items-center flex-col'>
                <h1 className='text-2xl font-bold mb-3'>What falls under IT?</h1>
                  <p className='text-lg text-secondary mx-3 mb-3'>Anything related to tech, essentially, falls under IT. This includes systems, apps, media, content, infrastructure, communication, storage, and more.</p>
                  <p className='text-lg text-secondary mx-3 mb-3'>Managed IT services constitutes everything related to IT that’s relevant for your company. The main areas usually include system, infrastructure, communication, and data storage.</p>
                  <p className='text-lg text-secondary mx-3'>Managed IT services are always customized for the business benefiting from them. Not every business has a need for every service that falls under IT. By narrowing your needs, we also lower the cost, so you don’t pay for what you don’t need/use. This is a feature of managed IT services that helps small businesses maintain profitability and functionality</p>
              </div>
          </div>
